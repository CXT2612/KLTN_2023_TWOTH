				...
				<div className="p-5">
					<div className="mb-3">
						<Link to="/blog/create" className="btn btn-info">
							<span className="d-flex align-items-center"><i className="eva eva-plus mr-2"></i> Tạo mới</span>
						</Link>
					</div>
					<BlogSearch { ...props } />
				</div>
										...
										< tr key={ key } className="table-product">
											...
											<td>
												<div className="d-flex justify-content-center align-items-center">
													<Link to={ `/blog/edit/${ item.id }` } className="d-flex justify-content-center">
